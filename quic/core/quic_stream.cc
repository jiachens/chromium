...
void QuicStream::CloseReadSide() {
  ...
  std::cout << "Done reading from stream " << id() << " " << getCurrentTime() << std::endl;
  ...
  if (write_side_closed_) {
    ...
    std::cout << "Closing stream " << id() << " " << getCurrentTime() << std::endl;
  }
}
...
void QuicStream::CloseWriteSide() {
  ...
  std::cout << "Done writing from stream " << id() << " " << getCurrentTime() << std::endl;
